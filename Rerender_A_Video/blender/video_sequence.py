...
class VideoSequence:
    ...
    def __init__(self,
        ...
        self.__input_dir = input_video_dir  ##
        self.__key_dir = key_frames_dir
    ...
    def get_flow_sequence(self, i, is_forward=True):
        ...
        if is_forward:
            ...
            path_dir = [
                os.path.join(self.__tmp_dir, 'flow_f_%05d.npy' % id)
                for id in id_list
            ]
        else:
            id_list = list(range(end_id, beg_id + 1, -1))
            path_dir = [
                os.path.join(self.__tmp_dir, 'flow_b_%05d.npy' % id)
                for id in id_list
            ]
